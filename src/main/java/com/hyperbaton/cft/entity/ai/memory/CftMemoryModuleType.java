...
public class CftMemoryModuleType {
    ...
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<BlockPos>> HOME_CONTAINER_POSITION = registerMemory("home_container_position", BlockPos.CODEC);
    ...
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<Boolean>> STRUCTURE_NEEDED = registerMemory("structure_needed", Codec.BOOL);

package com.hyperbaton.cft.entity.animations;
...
public class XoonglinAnimations {
    ...
    public static final AnimationDefinition XOONGLIN_WALK = AnimationDefinition.Builder.withLength(1.5F).looping()
            ...
            // Smooth leg forward-backward movement
            ...
            // Slight positional adjustment for legs to add weight
            .addAnimation("left_hip", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 1.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("right_hip", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 1.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            // Subtle head bobbing for dynamism
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(-2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.5F, KeyframeAnimations.degreeVec(2.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            // Antenna slight swing for liveliness
            .addAnimation("antenna", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.scaleVec(1.1F, 1.02F, 1.0F), AnimationChannel.Interpolations.LINEAR),

...
public class XunguiAnimations {
    public static final AnimationDefinition XUNGUI_IDLE = AnimationDefinition.Builder.withLength(1.0833F).looping()
            .addAnimation("right_shoulder", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -362.5F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.4167F, KeyframeAnimations.degreeVec(0.0F, -20.0F, -365.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.7917F, KeyframeAnimations.degreeVec(0.0F, 5.0F, -365.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            ...
            .addAnimation("left_shoulder", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.5833F, KeyframeAnimations.degreeVec(22.5F, 35.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.8333F, KeyframeAnimations.degreeVec(12.1181F, 20.9872F, -6.0896F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition XUNGUI_WALK = AnimationDefinition.Builder.withLength(1.5F).looping()
            ...
            .addAnimation("right_hip", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.5F, KeyframeAnimations.posVec(2.2F, 1.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(-1.6F, 1.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),

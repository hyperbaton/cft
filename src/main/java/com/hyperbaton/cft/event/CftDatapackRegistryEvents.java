...
public class CftDatapackRegistryEvents {
    ...
    public void newDatapackRegistry(DataPackRegistryEvent.NewRegistry event) {
        ...
        event.dataPackRegistry(JOB_KEY, Job.JOB_CODEC, Job.JOB_CODEC);
        event.dataPackRegistry(STRUCTURE_TYPE_KEY, StructureType.STRUCTURE_TYPE_CODEC, StructureType.STRUCTURE_TYPE_CODEC);
    }
